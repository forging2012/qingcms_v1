...
class Image
{
    ...
    static function water($image, $water, $waterPos =9,$padding,$min)
    {
	    //检查图片是否存在
	   ...
	   //读取原图像文件
        ...
        if($image_w<$min['w'] && $image_h<$min['h']) return null;
        ...
        $padding_X=$padding['x'];//水平边缘
        $padding_Y=$padding['y'];//竖直边缘
        switch ($waterPos) {
            case 0: //随机
